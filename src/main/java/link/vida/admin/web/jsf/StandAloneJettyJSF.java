...
// * @author dcaro
// */
//public class StandAloneJettyJSF implements UncaughtExceptionHandler {
//
...
//
//    public StandAloneJettyJSF(int port) {
//
...
//    }
//
//    public static void displayTrayIcon(final int port) throws Exception {
//        if (!GraphicsEnvironment.isHeadless()) {
//            final TrayIcon trayIcon = new TrayIcon(new ImageIcon(StandAloneJettyJSF.class.getResource("/pf.png")).getImage());
