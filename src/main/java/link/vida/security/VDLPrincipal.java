 ...
 */
public class VDLPrincipal implements Principal, java.io.Serializable {
     ...
     *                  is <code>null</code>.
     */
    public VDLPrincipal(String name) {
        if (name == null)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VDLPrincipal))
            return false;
        VDLPrincipal that = (VDLPrincipal)o;
